...
public class Crx3InterpreterTest {
    ...
    public void sameId() throws Exception {
        ...
        checkState(CrxVersion.CRX3.equals(metadata3.getCrxVersion()), "this test only makes sense if the version is 3");
    ...
    private CrxMetadata loadVersion2() throws Exception {
        ...
        checkState(CrxVersion.CRX2.equals(metadata.getCrxVersion()), "this test only makes sense if the version is 2");
        return metadata;
    }
