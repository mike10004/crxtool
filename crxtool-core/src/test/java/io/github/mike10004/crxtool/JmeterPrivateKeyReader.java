// https://stackoverflow.com/a/29827944/2657036
 ...
 *
 */
@SuppressWarnings({"JavaDoc", "unused", "Convert2Diamond", "UnusedAssignment"})
public class JmeterPrivateKeyReader {
    ...
    public PrivateKey getPrivateKey(Reader reader) throws IOException, GeneralSecurityException
    {
        PrivateKey key = null;
        ...
        byte[] encoded = parseBase64Binary(builder.toString());
        if (isRSAKey)
        {
    ...
    private static byte[] parseBase64Binary(String base64) {
